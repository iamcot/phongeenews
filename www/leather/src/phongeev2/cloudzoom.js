        ...
        */
        if (opts.centerXY) {
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:'+opts.fixZoomWindow+'px;top:%1px;width:%2px;height:%3px;background:#fff url(\'%4\') no-repeat;z-index:99;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');

        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    <h1 class="error-text-2 bounceInDown animated"> Lỗi 404 <span
                    ...
                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i>
                            Trang <u>không</u> tìm thấy</strong>
                    </h2>
                    <br/>
                    ...
                    <p class="font-md">
                        <b>Hãy thử tìm kiếm</b>
                    </p>
                    <br>

                    <div class="error-search well well-lg padding-10" style="max-width: 400px;margin: 10px auto ;">

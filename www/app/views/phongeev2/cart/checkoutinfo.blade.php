...
<div id="cartpage" class="container-fluid">
    ...
    <div class="wrap">
        @if($orderinfo != null)
        <div class="bg-success hidden-print padding-15"><strong>Đơn hàng đã được gửi đi, chúng tôi sẽ liên hệ giao hàng cho quý khách trong thời gian sớm nhất.</strong>
            <br>
